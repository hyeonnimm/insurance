    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <BoundedContext1987Payment :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <BoundedContext1987Payment :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import BoundedContext1987Payment from './../BoundedContext1987Payment.vue';

    export default {
        name: 'BoundedContext1987PaymentManager',
        components: {
            BoundedContext1987Payment,
        },
        props: {
            offline: Boolean
        },
